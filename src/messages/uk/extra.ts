...
export const whyChoose = {
  ...
  cards: [
    ...
    "Працюємо по всій Україні і по всьому світу",
  ],
};
...
export const precisionQuality = {
  ...
  p2:
    "Мікроскоп — це гарантія точності та ідеальної посадки, завдяки якій лікар і пацієнт залишаються задоволені результатом.",
};
...
export const ourTeam = {
  ...
  title: "Наша команда",
  members: [
    { name: "Наталя Данилів", role: "Директор лабораторії" },
    { name: "Марія Бондар", role: "Операційний директор" },
    { name: "Оксана Федунь", role: "Старший Адміністратор" },
    { name: "Ірина Дзюбенко", role: "Старший Кераміст" },
    { name: "Софія Пастущак", role: "Старший Кераміст" },
    { name: "Марія Ковальчук", role: "Адміністратор" },
    { name: "Катя Микитюк", role: "CAD Дизайнер" },
    { name: "Володимир Лозинський", role: "Старший Кераміст" },
    { name: "Анна Шушереба", role: "Менеджер із постачання" },
    { name: "Ярослав Снядецький", role: "Експерт з CAD дизайну" },
    { name: "Антон Давиденко", role: "CAD Дизайнер" },
    { name: "Любомир Гаваль", role: "Фахівець з обробки та висадки" },
    { name: "Мар'ян Микитюк", role: "Знімне протезування" },
    { name: "Віталій Лещинський", role: "Гіпсувальник та сканувальник" },
    { name: "Віталій Котик", role: "Гіпсувальник" },
  ],
};
